  ...
  return (
    <li>
      <Link
        ...
        className={cn(
          'dark:text-white dark:hover:bg-zinc-700 dark:hover:text-white',
          path === actualRoute
            ? 'bg-zinc-200 text-gray-900 dark:bg-white dark:text-black'
            : 'bg-white dark:bg-black text-gray-600 hover:bg-gray-100',
...
export default function Sidebar() {
  ...
  return (
    <div aria-label='Sidebar' className='h-full w-40'>
      <div className='flex flex-col justify-between overflow-y-auto py-4'>
